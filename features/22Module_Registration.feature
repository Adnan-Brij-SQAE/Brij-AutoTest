@allure.feature.RegistrationModule @severity.critical
Feature: Test Registration Module Page

@allure.feature.RegistrationModule @story.navigation @severity.critical
Scenario: Verify navigation to Registration Module page
  When the user navigates to the Registration Module page

@allure.feature.RegistrationModule @story.ui_controls @severity.normal
...
@allure.feature.RegistrationModule @story.field_visibility @severity.normal
...
@allure.feature.RegistrationModule @story.selection @severity.normal
...
@allure.feature.RegistrationModule @story.crud_operations @severity.critical
...
@allure.feature.RegistrationModule @story.table_operations @severity.critical
...
@allure.feature.RegistrationModule @story.search @severity.high
