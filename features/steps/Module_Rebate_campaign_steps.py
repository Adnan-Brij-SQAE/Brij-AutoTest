...
def step_impl(context):
    with allure.step("Create new Rebate Campaign module"):
        try:
            ...
            helper.insert_text_in_input_field(locators.REBATE_CAMPAIGN_BUYX_GETY_QUANTITY,"5")
            log.info("entered quantity ")
            helper.insert_text_in_input_field(locators.REBATE_CAMPAIGN_BUYX_GETY_PAYOUT,"2")
            ...
            helper.insert_text_in_input_field(locators.REBATE_CAMPAIGN_BUYX_GETY_MAX,"5")
...
def step_impl(context):
    with allure.step("Edit Rebate Campaign module"):
        try:
            ...
            time.sleep(2)
            helper.insert_text_in_input_field(locators.REBATE_CAMPAIGN_POPUP_MODULE_NAME, "Auto Updated Rebate Campaign")
            log.info("Renamed the  Rebate Campaign Popup")
            helper.capture_screenshot()
            helper.wait_till_element_is_present_to_click(locators.REBATE_CAMPAIGN_SAVE)
            log.info('Rebate Campaign  Upted successfully')
            helper.wait_till_element_is_present_to_click(locators.REBATE_CAMPAIGN_CLOSE)
        except Exception as e:
...
def step_impl(context):
    with allure.step("Create duplicate Rebate Campaign module"):
        try:
            ...
            helper.capture_screenshot()
            helper.wait_till_element_is_present_to_click(locators.REBATE_CAMPAIGN_SAVE)
            log.info('Duplicate Rebate Campaign  duplicated successfully')
            helper.wait_till_element_is_present_to_click(locators.REBATE_CAMPAIGN_CLOSE)
        except Exception as e:
