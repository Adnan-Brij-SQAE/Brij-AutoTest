...
def step_create_new_module(context):
    with allure.step("User creates a new Sweepstakes module"):
        try:
            ...
            Envi_Helper(context.page).insert_text_in_input_field(locators.SWEEPSTAKES_POPUP_AS_TEXT1,"Auto text1")
            Envi_Helper(context.page).insert_text_in_input_field(locators.SWEEPSTAKES_POPUP_AS_TEXT2, "Auto text2")
            Envi_Helper(context.page).insert_text_in_input_field(locators.SWEEPSTAKES_POPUP_AS_TEXT3, "Auto text3")
            Envi_Helper(context.page).insert_text_in_input_field(locators.SWEEPSTAKES_POPUP_AS_TEXT4, "Auto text4")
