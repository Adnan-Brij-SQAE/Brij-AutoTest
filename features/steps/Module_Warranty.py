...
def step_navigate_to_warranty_module_page(context):
    with allure.step("User navigates to the Warranty Module page"):
        ...
        module_menu.click()
        Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_OPTION)
        time.sleep(2)
...
def step_warranty_module_page_displayed(context):
    with allure.step("Verify Warranty Module page is displayed"):
        try:
            Envi_Helper(context.driver).get_value(locators.WARRANTY_TITLE)
...
def step_access_notification_button(context):
    with allure.step("Verify notification button is accessible"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.Warranty_NOTIFICATION_ICON)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.Warranty_NOTIFICATION_ICON)
...
def step_access_logout_button(context):
    with allure.step("Verify logout button is accessible"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_LOGOUT_BUTTON)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_LOGOUT_BUTTON)
...
def step_access_field_button(context):
    with allure.step("Verify field button is accessible"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_BUTTON)
...
def step_impl(context):
    with allure.step("Verify Warranty Name field is accessible"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WARRANTY_NAME)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WARRANTY_NAME)
...
def step_impl(context):
    with allure.step("Verify Where Used field is accessible"):
        try:
            # Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_BUTTON)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WHERE_USED)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WHERE_USED)
...
def step_impl(context):
    with allure.step("Verify Warranty Duration field is accessible"):
        try:
            # Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_BUTTON)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WARRANTY_DURATION)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_WARRANTY_DURATION)
...
def step_impl(context):
    with allure.step("Verify call to Action field is accessible"):
        try:
            # Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_BUTTON)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_CTA)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_CTA)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_FIELD_BUTTON)
...
def step_select_all_checkboxes(context):
    with allure.step("User selects all checkboxes"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_SELECT_ALL_CHECKBOXES)
            Envi_Helper.capture_screenshot()
        except Exception as e:
            log.error(f"Filter failed: {e}")
...
def step_use_search_feature(context):
    with allure.step("User uses the search feature"):
        try:
            Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_SEARCH, "test")
        except Exception as e:
...
def step_sort_table(context):
    with allure.step("User sorts the table"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_WARRANTY_NAME)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_WARRANTY_NAME)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_WHERE_USED)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_WHERE_USED)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DURATION)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DURATION)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_CALL_TO_ACTION)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_CALL_TO_ACTION)
        except Exception as e:
...
def step_create_new_module(context):
    with allure.step("User creates a new Warranty module"):
        # try:
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_NEW_MODULE)
        #     time.sleep(2)
        #     Envi_Helper(context.driver).capture_screenshot()
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_MODULE_NAME, "Auto Warranty Test")
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_CTA, "Testing")
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_DURATION_DAYS, "5")
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DURATION_TYPE)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DURATION_TYPE_MONTHS)
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_IMAGE_EDITOR,"Auto Description")
        #     Envi_Helper.capture_screenshot()
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_INCLUDE_CLAIM)
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_CLAIM_TEXT, "Auto claim text")
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_CLAIM_LINK, "https://www.testing.com")
        #     Envi_Helper.capture_screenshot()
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_MULLBERY_CHECK)
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_CLAIM_TEXT, "Auto claim text")
        #     Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_CLAIM_LINK, "https://www.testing.com")
        #     Envi_Helper.capture_screenshot()
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_MULLBERY_CHECK)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_HEADER_TEXT)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_TEXT_BODY)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_EXTENTION_CTA)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_SHOW_STATUS)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_DURATION_SCREEN)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_STATE)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_STATE_PENDING)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_STATE_DENIED)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_POST_CTA)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_POST_CTA_TEXT)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_CUSTOMIZE_COLOUR)
        #     keyboard.press_and_release('Page Up')
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_SAVE_BUTTON)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_BACK)
        #     time.sleep(2)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_SAVE_BUTTON)
        #     Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_CLOSE)
        #     time.sleep(2)
        try:
            ...
            try:
                Envi_Helper(context.driver).wait_till_element_is_present_to_click(
                    locators.WARRANTY_DURATION_TYPE_MONTHS)
            except Exception as e:
            ...
            try:
                Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_CLAIM_LINK,
            ...
            try:
                keyboard.press_and_release('Page Up')
                Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_SAVE)
            except Exception as e:
                log.error(f"Failed at WARRANTY_AS_SAVE_BUTTON: {e}")
                allure.attach(str(e), name="WARRANTY_AS_SAVE_BUTTON", attachment_type=allure.attachment_type.PNG)
                raise

            try:
                Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_AS_BACK)
            except Exception as e:
                log.error(f"Failed at WARRANTY_AS_BACK: {e}")
                allure.attach(str(e), name="WARRANTY_AS_BACK", attachment_type=allure.attachment_type.PNG)
                raise
            ...
            try:
                ...
                log.error(f"Failed at WARRANTY_POPUP_SAVE_BUTTON: {e}")
                allure.attach(str(e), name="WARRANTY_POPUP_SAVE_BUTTON", attachment_type=allure.attachment_type.PNG)
                raise

            try:
                Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_CLOSE)
            except Exception as e:
                log.error(f"Failed at WARRANTY_POPUP_CLOSE: {e}")
                allure.attach(str(e), name="WARRANTY_POPUP_CLOSE", attachment_type=allure.attachment_type.PNG)
                raise
...
def step_verify_new_module_added(context):
    with allure.step("Verify new Warranty module is added"):
        try:
            Envi_Helper(context.driver).get_value(locators.WARRANTY_LIST, 10)
...
def step_edit_module(context):
    with allure.step("User edits an existing Warranty module"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_LIST_KEBAB)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_EDIT_OPTION)
            time.sleep(2)
            Envi_Helper(context.driver).capture_screenshot()
            Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_MODULE_NAME, "Updated Auto Warranty Test",10)
            Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_CTA, " updated Testing",10)
            Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_POPUP_IMAGE_EDITOR," Updated Auto Description")
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_SAVE_BUTTON)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_CROSS)
            time.sleep(2)
        except Exception as e:
...
def step_delete_module(context):
    with allure.step("User deletes an unused Warranty module"):
        try:
            Envi_Helper(context.driver).insert_text_in_input_field(locators.WARRANTY_SEARCH,"Auto")
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_LIST_KEBAB)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DELETE_BUTTON)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_CONFIRM_DELETE_BUTTON)
            # Envi_Helper(context.driver).get_toast_message(locators.WARRANTY_CONFIRM_DELETE_toast)
            Envi_Helper.capture_screenshot()
            time.sleep(2)
        except Exception as e:
...
def step_delete_module(context):
    with allure.step("User deletes more than one Warranty module"):
        try:
            ...
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_SELECT_ALL_CHECKBOXES)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_DELETEALL_BUTTON)
            time.sleep(2)
            Envi_Helper.capture_screenshot()
        except Exception as e:
...
def step_impl(context):
    with allure.step("Verify warranty duplicate "):
        try:
            ...
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_EDIT_OPTION)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_DUPLICATE)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_SAVE_BUTTON)
            time.sleep(2)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_POPUP_CROSS)
...
def step_impl(context):
    with allure.step("User checks number of rows in WARRANTY module"):
        try:
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_OPTION)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_100)
            time.sleep(2)
            Envi_Helper.capture_screenshot()
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_OPTION)
            Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_1000)
            time.sleep(2)
            Envi_Helper.capture_screenshot()
            # Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_OPTION)
            # Envi_Helper(context.driver).wait_till_element_is_present_to_click(locators.WARRANTY_ROWPERPAGE_20)
            # time.sleep(2)
            # Envi_Helper.capture_screenshot()
        except Exception as e:
